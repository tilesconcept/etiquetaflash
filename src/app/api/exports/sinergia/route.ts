...
import { exportSinergia, validateForSinergia } from '@/services/exporters/sinergiaExporter';
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const issues = validateForSinergia(orders, ctx);
    ...
    const out = await exportSinergia(orders, ctx);
